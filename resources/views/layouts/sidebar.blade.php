<aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <img src="{{asset('assets')}}/dist/img/greatday_circle.png" alt="AdminLTE Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
    <span class="brand-text font-weight-light">GreatDay HR</span>
    </a>
